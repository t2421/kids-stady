  ...
  npcs: [
      ...
      dialog: [
        {
          ...
          pages: [
            "おお… 数《かず》ゆうしゃ ピタゴラよ! 2つの せかいに 数《かず》を もどした えいゆうじゃ!",
        ...
        },
        {
          ...
          pages: [
            ...
            "つぎの すうしょうは 海《うみ》のむこう、みなとまち ミナトスに あるらしい。",
            "みなみの かいがんに 船《ふね》を よういさせた。船《ふね》のりに こえを かけるのじゃ!",
          ],
          then: [
        ...
        },
        {
          pages: [
            ...
            "ケシケシぐんだんに 「すうしょう・壱《いち》」を うばわれてしもうた…",
    ...
    },
    {
      ...
      dialog: [
        {
          pages: [
            "わしは ふくろう博士《はかせ》。しろの まなびやで かずを おしえておる。",
  ...
  npcs: [
    {
      ...
      dialog: [
        {
          pages: [
            "ここは モリカゲの まなびや。ふくろう博士《はかせ》の でししが おしえておるぞ。",
